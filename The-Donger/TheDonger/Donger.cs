            ...
            if (useQ && spells[Spells.Q].IsReady() && qtarget.IsValidTarget(650f) && Player.Position.CountEnemiesInRange(650) >= 1) {
                ...
                if (DongerMenu.Config.Item("Combo.Zhonyas").GetValue<bool>()) {
                    ...
                    if (HP <= critHP) {
                        ...
                        Utility.DelayAction.Add(1010, () => spells[Spells.Q].Cast(Player.Position));
                        Utility.DelayAction.Add(500, () => spells[Spells.Q].Cast(Player.Position));
                        Utility.DelayAction.Add(1200, () => Zhonyas.Cast());
                    }
                }
